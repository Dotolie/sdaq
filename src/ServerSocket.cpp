...
const CServerSocket& CServerSocket::operator << ( const std::string& s ) const
{
	if( ! CSocket::send( s ) )
	{
...
const CServerSocket& CServerSocket::operator >> ( std::string& s ) const
{
	if( ! CSocket::recv ( s ) )
	{
